...
class AlertExample extends BakerExample {
    ...
    render_icon() {
        return this.render_exampleComponent(
            ...
            >
                {/* this icon would come from a package/component and is only used here as an tabBar.js   */}
            ...
            'Test with icon passed in. With click event.'
        );
    }
    ...
    render_error_icon() {
        return this.render_exampleComponent(
            ...
            'Test error with icon passed in. With click event.'
        );
    }
    ...
    render_success_icon() {
        return this.render_exampleComponent(
            ...
            'Test success with icon passed in. With click event.'
        );
    }
}
